...
App Key ช่วยป้องกันการส่งข้อมูลแบบสุ่ม แต่ไม่ใช่ระบบยืนยันตัวตนที่สมบูรณ์ เพราะค่าจาก Vite สามารถตรวจดูได้ในเบราว์เซอร์ รุ่นแรกจึงควรใช้ URL เฉพาะภายในโรงเรียนและไม่เผยแพร่สู่สาธารณะ ก่อนใช้งานจริงกับข้อมูลนักเรียนควรเพิ่มระบบ Google Sign-In หรือจำกัดผู้ใช้ด้วยบัญชี Google Workspace ของโรงเรียน
