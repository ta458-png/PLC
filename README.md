...
- โฟลเดอร์ `HRP PLC Uploads` เก็บรูปแยกตามชื่อกลุ่มและโฟลเดอร์กิจกรรม โดยใช้รูปแบบ `วันเดือนปีพ.ศ.ครั้งที่` เช่น `1407256901`
...
หากมีโฟลเดอร์กิจกรรมรุ่นเก่าที่ชื่อเป็น UUID ให้เลือกฟังก์ชัน `renameExistingActivityFolders` ใน Apps Script แล้วกด Run หนึ่งครั้ง ระบบจะเปลี่ยนเฉพาะชื่อโฟลเดอร์เดิมตามครั้งที่และวันที่ โดยไม่ย้ายหรือลบรูปภาพ
